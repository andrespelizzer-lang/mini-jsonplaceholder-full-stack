<template>
  <div class="card">
    ...
    <div class="azioni">
      ...
      <button v-if="isAdmin" class="btn-secondario" @click="$emit('modifica', utente)">Modifica</button>
...
const creatoIl = computed(() =>
  props.utente.creatoIl
    ? new Date(props.utente.creatoIl).toLocaleString('it-IT', { timeZone: 'Europe/Rome' })
    : '-'
)
</script>
